...
*     =insevertice                  inxGrafo	id		string		string		string		string		inxVertice		inxIds		CondRetEsp
*     =insearestcorr                inxGrafo	id		CondRetEsp
*	  =verifvertice					inxGrafo	id		CondRetEsp
*	  =excluirvertcorr              inxGrafo	CondRetEsp
*	  =excluiraresta                inxGrafo	id		id2			CondRetEsp
*     =obtervalorcorr               inxGrafo	id		string		string		string		string		ValEsp 
*	  =irinicio						inxGrafo	CondRetEsp
*	  =avancarvertcorr				inxGrafo	CondRetEsp
*	  =obtemarestcorr				inxGrafo	CondRetEsp 
*
******************************************************************************/
	  ...
	  /* Efetuar reset de teste de grafo */
		...
		/* Testar destruir grafo */
          ...
          else if ( strcmp( ComandoTeste ,DESTRUIR_GRAFO_CMD  ) == 0 )
         {
           ...
           return TST_CompararPonteiroNulo( 0 , vtGrafo[ inxGrafo ] ,
												  "Erro em destruir o grafo."  ) ;
		...
		/*Testar Obter Aresta Vértice Corrente */
			...
			vtVertice[inxGrafo] = (tpInfo*) GRA_ObtemArestasVerticeCorrente( vtGrafo[ inxGrafo ] );

			return TST_CompararPonteiroNulo( CondRetEsp , vtVertice[inxGrafo] ,
